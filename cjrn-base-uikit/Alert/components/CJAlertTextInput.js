...
export class CJAlertNormalTextInput extends Component {
    static propTypes = {
    ...
    render() {
        return (
            <TextInput
                style={[
                    CJTheme.style.textInputStyle,
                    this.props.style,
                ]}
                keyboardType={this.props.keyboardType}
                placeholder={this.props.placeholder}
                placeholderTextColor={CJTheme.placeholderTextColor}
...
export class CJAlertTemperatureTextInput extends CJAlertNormalTextInput {
    constructor(props) {
        super(props);
